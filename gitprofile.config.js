...
const config = {
  github: {
    ...
    exclude: {
      ...
      projects: ['AmazonAffiliateNotifications', 'ClusterCrawler', 'PetDiabetesAssistant', 'prettytree'], // These projects will not be displayed. example: ['my-project1', 'my-project2']
    },
  },
  social: {
